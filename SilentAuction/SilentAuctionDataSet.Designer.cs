...
namespace SilentAuction {
    ...
    public partial class SilentAuctionDataSet : global::System.Data.DataSet {
        ...
        public partial class ItemsDataTable : global::System.Data.TypedTableBase<ItemsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ItemsRow AddItemsRow(long DonorId, long AuctionId, string Name, string Description, long Qty, string Notes, string DonorName, string CreateDate, string ModifiedDate) {
...
namespace SilentAuction.SilentAuctionDataSetTableAdapters {
    ...
    public partial class ItemsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SQLite.SQLiteCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = @"SELECT        Items.Id, Items.DonorId, Items.AuctionId, Items.Name, Items.Description, Items.Qty, Items.Notes, Donors.Name AS DonorName, Items.CreateDate, 
                         Items.ModifiedDate
...
WHERE        (Items.AuctionId = @AuctionId)";
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int FillItems(SilentAuctionDataSet.ItemsDataTable dataTable, global::System.Nullable<long> AuctionId) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual SilentAuctionDataSet.ItemsDataTable GetDataItems(global::System.Nullable<long> AuctionId) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((AuctionId.HasValue == true)) {
                this.Adapter.SelectCommand.Parameters[0].Value = ((long)(AuctionId.Value));
            }
